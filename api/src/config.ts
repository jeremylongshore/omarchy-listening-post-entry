...
const PRODUCTION_WEB_ORIGIN = "https://perception.intentsolutions.io";
...
export function loadRuntimeConfig(env:Record<string, string | undefined>):RuntimeConfig {
  ...
  return {
    production, port, databasePath, webOrigin, apiOrigin,
    logLevel:env.LOG_LEVEL?.trim() || "info", checkoutUrl, lemonSqueezy, smtp,
